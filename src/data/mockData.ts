...
export const collaborators: Collaborator[] = [
  { id: 'collab-city', name: 'Colaborador institucional', mediaAsset: image, sortOrder: 1, isActive: true, isSpecial: true, isAuxiliary: false, showName: true, translations: { es: { displayName: 'Colaborador institucional', thankYouText: 'Agradecimiento especial pendiente de configurar.' }, en: { displayName: 'Institutional collaborator', thankYouText: 'Special thanks pending configuration.' }, fr: { displayName: 'Collaborateur institutionnel' }, de: { displayName: 'Institutioneller Partner' } } }
];
